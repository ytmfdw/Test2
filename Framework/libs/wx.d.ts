...
declare namespace wx {
  export function createInterstitialAd(data: any): any;
  export function getFileSystemManager(): any;
  export function getUpdateManager(): any;
  export function aldOnShareAppMessage(data: any): void;
  export function aldShareAppMessage(data: any): void;
  export function aldSendEvent(data: any, value: any): void;
  export function shareAppMessage(data: any): void;
  export function setUserCloudStorage(data: any): void;
  export function createBannerAd(data: any): void;
  export function createRewardedVideoAd(data: any): void;
  export function onShareAppMessage(data: any): void;
  export function onHide(data: any): void;
  export function onShow(data: any): void;
  export function getOpenDataContext(): any;
  export function createUserInfoButton(obj: any): any;
  export function getLaunchOptionsSync(): any;
  /**
   * 批量添加卡券。
   */
  export function addCard(any: _addCardObject): void;

  /**
   * 调用后，用户可以选择将该表单以“新增联系人”或“添加到已有联系人”的方式，写入手机系统通讯录，完成手机通讯录联系人和联系方式的增加。
   */
  export function addPhoneContact(any: _addPhoneContactObject): void;
   ...
   */
  export function authorize(any: any): void;
   ...
   */
  export function canvasGetImageData(any: _canvasGetImageDataObject): void;

  /**
   * 将像素数据绘制到画布的方法
   */
  export function canvasPutImageData(any: _canvasPutImageDataObject): void;
  ...
  export function canvasToTempFilePath(
    this: string,
    any: _canvasToTempFilePathObject
  ): void;
  ...
  export function checkIsSoterEnrolledInDevice(
    any: _checkIsSoterEnrolledInDeviceObject
  ): void;
  ...
  export function checkIsSupportSoterAuthentication(
    any: _checkIsSupportSoterAuthenticationObject
  ): void;
   ...
   */
  export function checkSession(any: _checkSessionObject): void;

  /**
   * 调起用户编辑收货地址原生界面，并在编辑完成后返回用户选择的地址。
   */
  export function chooseAddress(any: _chooseAddressObject): void;

  /**
   * 调起选择手机通讯录联系人界面，返回用户选择的联系人信息。
   */
  export function chooseContact(any: _chooseContactObject): void;

  /**
   * 从本地相册选择图片或使用相机拍照。
   */
  export function chooseImage(any: _chooseImageObject): void;

  /**
   * 选择用户的发票抬头。
   */
  export function chooseInvoiceTitle(any: _chooseInvoiceTitleObject): void;

  /**
   * 打开地图选择位置。
   */
  export function chooseLocation(any: _chooseLocationObject): void;

  /**
   * 拍摄视频或从手机相册中选视频，返回视频的临时文件路径。
   */
  export function chooseVideo(any: _chooseVideoObject): void;
   ...
   * 断开与低功耗蓝牙设备的连接
   */
  export function closeBLEConnection(any: _closeBLEConnectionObject): void;
  ...
  export function closeBluetoothAdapter(
    any: _closeBluetoothAdapterObject
  ): void;

  /**
   * 关闭 WebSocket 连接。
   */
  export function closeSocket(any?: any): void;

  /**
   * 创建一个 [WebSocket](https://developer.mozilla.org/zh-CN/docs/Web/API/WebSocket) 连接。**使用前请先阅读[说明](./api-network.md)**。
   */
  export function connectSocket(any: _connectSocketObject): void;

  /**
   * 连接 Wi-Fi。若已知 Wi-Fi 信息，可以直接利用该接口连接。仅 Android 与 iOS 11 以上版本支持。
   */
  export function connectWifi(any: _connectWifiObject): void;

  /**
   * 创建一个动画实例[animation](#animation)。调用实例的方法来描述动画。最后通过动画实例的`export`方法导出动画数据传递给组件的`animation`属性。
   */
  export function createAnimation(any: _createAnimationObject): void;
   ...
   * 连接低功耗蓝牙设备。
   */
  export function createBLEConnection(any: _createBLEConnectionObject): void;
   ...
   */
  export function downloadFile(any: any): any;

  /**
   * 蓝牙设备characteristic(特征值)信息
   */
  export function getBLEDeviceCharacteristics(
    any: _getBLEDeviceCharacteristicsObject
  ): void;
  ...
  export function getBLEDeviceServices(
    any: _getBLEDeviceServicesObject
  ): void;
  ...
  export function getBackgroundAudioPlayerState(
    any: _getBackgroundAudioPlayerStateObject
  ): void;

  /**
   * 获取所有已搜索到的`iBeacon`设备
   */
  export function getBeacons(any: _getBeaconsObject): void;

  /**
   * 获取本机蓝牙适配器状态
   */
  export function getBluetoothAdapterState(
    any: _getBluetoothAdapterStateObject
  ): void;

  /**
   * 获取在小程序蓝牙模块生效期间所有已发现的蓝牙设备，包括已经和本机处于连接状态的设备。
   */
  export function getBluetoothDevices(any: _getBluetoothDevicesObject): void;

  /**
   * 获取系统剪贴板内容
   */
  export function getClipboardData(any: _getClipboardDataObject): void;

  /**
   * 根据 uuid 获取处于已连接状态的设备
   */
  export function getConnectedBluetoothDevices(
    any: _getConnectedBluetoothDevicesObject
  ): void;

  /**
   * 获取已连接中的 Wi-Fi 信息
   */
  export function getConnectedWifi(any: _getConnectedWifiObject): void;

  /**
   * 获取第三方平台自定义的数据字段。
   */
  export function getExtConfig(any: _getExtConfigObject): void;
   ...
   * 获取文件信息
   */
  export function getFileInfo(any: _getFileInfoObject): void;

  /**
   * 判断当前设备是否支持 HCE 能力。
   */
  export function getHCEState(any: _getHCEStateObject): void;

  /**
   * 获取图片信息
   */
  export function getImageInfo(any: _getImageInfoObject): void;

  /**
   * 获取当前的地理位置、速度。当用户离开小程序后，此接口无法调用；当用户点击“显示在聊天顶部”时，此接口可继续调用。
   */
  export function getLocation(any: _getLocationObject): void;

  /**
   * 获取网络类型。
   */
  export function getNetworkType(any: _getNetworkTypeObject): void;

  /**
   * 获取微信替设备生成的唯一标识，用于判断设备是否更换。获取的数据为AES加密数据，需要自行解密。
   */
  export function getOpenDeviceId(any: _getOpenDeviceIdObject): void;
   ...
   */
  export function getSavedFileInfo(any: _getSavedFileInfoObject): void;

  /**
   * 获取本地已保存的文件列表
   */
  export function getSavedFileList(any: _getSavedFileListObject): void;

  /**
   * 获取屏幕亮度。
   */
  export function getScreenBrightness(any: _getScreenBrightnessObject): void;
   ...
   * 获取转发详细信息
   */
  export function getShareInfo(any: any): void;

  /**
   * 从本地缓存中异步获取指定 key 对应的内容。
   */
  export function getStorage(any: _getStorageObject): void;

  /**
   * 异步获取当前storage的相关信息
   */
  export function getStorageInfo(any: _getStorageInfoObject): void;

  /**
   * 同步获取当前storage的相关信息
   */
  export function getStorageInfoSync(): any;
   ...
   * 获取系统信息。
   */
  export function getSystemInfo(any: _getSystemInfoObject): void;
   ...
   */
  export function getUserInfo(any: _getUserInfoObject): void;

  /**
   * 获取用户过去三十天微信运动步数，需要先调用 [wx.login](./api-login.md#wxloginobject) 接口。
   */
  export function getWeRunData(any: _getWeRunDataObject): void;

  /**
   * 请求获取 Wi-Fi 列表，在 `onGetWifiList` 注册的回调中返回 wifiList 数据。iOS 将跳转到系统的 Wi-Fi 界面，Android 不会跳转。
   */
  export function getWifiList(any: _getWifiListObject): void;
   ...
   * 隐藏转发按钮
   */
  export function hideShareMenu(any: _hideShareMenuObject): void;

  /**
   * 隐藏 tabBar
   */
  export function hideTabBar(any: _hideTabBarObject): void;

  /**
   * 隐藏 tabBar 某一项的右上角的红点
   */
  export function hideTabBarRedDot(any: _hideTabBarRedDotObject): void;
   ...
   */
  export function login(any: any): void;

  /**
   * wx.makePhoneCall({
   */
  export function makePhoneCall(any: _makePhoneCallObject): void;

  /**
   * 调起 VoIP 音视频通话界面。
   */
  export function makeVoIPCall(any: _makeVoIPCallObject): void;

  /**
   * 关闭当前页面，返回上一页面或多级页面。可通过 [`getCurrentPages()`](../framework/app-service/page.md#getCurrentPages()) 获取当前的页面栈，决定需要返回几层。
   */
  export function navigateBack(any: _navigateBackObject): void;

  /**
   * 返回到上一个小程序，只有在当前小程序是被其他小程序打开时可以调用成功
   */
  export function navigateBackMiniProgram(
    any: _navigateBackMiniProgramObject
  ): void;

  /**
   * 保留当前页面，跳转到应用内的某个页面，使用`wx.navigateBack`可以返回到原页面。
   */
  export function navigateTo(any: _navigateToObject): void;
  ...
  export function notifyBLECharacteristicValueChange(
    any: _notifyBLECharacteristicValueChangeObject
  ): void;
  ...
  export function openBluetoothAdapter(
    any: _openBluetoothAdapterObject
  ): void;

  /**
   * 查看微信卡包中的卡券。
   */
  export function openCard(any: _openCardObject): void;

  /**
   * 新开页面打开文档，支持格式：doc, xls, ppt, pdf, docx, xlsx, pptx
   */
  export function openDocument(any: _openDocumentObject): void;

  /**
   * ​使用微信内置地图查看位置。
   */
  export function openLocation(any: _openLocationObject): void;

  /**
   * 调起客户端小程序设置界面，返回用户设置的操作结果。
   */
  export function openSetting(any: any): void;

  /**
   * 将页面滚动到目标位置。
   */
  export function pageScrollTo(any: _pageScrollToObject): void;
   ...
   */
  export function playBackgroundAudio(any: _playBackgroundAudioObject): void;

  /**
   * 开始播放语音，同时只允许一个语音文件正在播放，如果前一个语音文件还没播放完，将中断前一个语音播放。
   */
  export function playVoice(any: _playVoiceObject): void;

  /**
   * 预览图片。
   */
  export function previewImage(any: any): void;

  /**
   * 关闭所有页面，打开到应用内的某个页面。
   */
  export function reLaunch(any: _reLaunchObject): void;
  ...
  export function readBLECharacteristicValue(
    any: _readBLECharacteristicValueObject
  ): void;

  /**
   * 关闭当前页面，跳转到应用内的某个页面。
   */
  export function redirectTo(any: _redirectToObject): void;

  /**
   * 删除本地存储的文件
   */
  export function removeSavedFile(any: _removeSavedFileObject): void;

  /**
   * 从本地缓存中异步移除指定 key 。
   */
  export function removeStorage(any: any): void;
   ...
   * 移除 tabBar 某一项右上角的文本
   */
  export function removeTabBarBadge(any: _removeTabBarBadgeObject): void;
   ...
   */
  export function request(any: any): void;

  /**
   * 发起微信支付。
   */
  export function requestPayment(any: _requestPaymentObject): void;

  /**
   * 保存文件到本地。**注意：saveFile 会把临时文件移动，因此调用成功后传入的 tempFilePath 将不可用**
   */
  export function saveFile(any: _saveFileObject): void;
  ...
  export function saveVideoToPhotosAlbum(
    any: _saveVideoToPhotosAlbumObject
  ): void;

  /**
   * 调起客户端扫码界面，扫码成功后返回对应的结果
   */
  export function scanCode(any: _scanCodeObject): void;

  /**
   * 控制音乐播放进度。
   */
  export function seekBackgroundAudio(any: _seekBackgroundAudioObject): void;

  /**
   * 发送 NFC 消息。仅在安卓系统下有效。
   */
  export function sendHCEMessage(any: _sendHCEMessageObject): void;

  /**
   * 通过 WebSocket 连接发送数据，需要先 [wx.connectSocket](#wxconnectsocketobject)，并在 [wx.onSocketOpen](#wxonsocketopencallback) 回调之后才能发送。
   */
  export function sendSocketMessage(any: any): void;

  /**
   * 设置系统剪贴板的内容
   */
  export function setClipboardData(any: _setClipboardDataObject): void;

  /**
   * 设置是否打开调试开关，此开关对正式版也能生效。
   */
  export function setEnableDebug(any: _setEnableDebugObject): void;

  /**
   * 设置是否保持常亮状态。仅在当前小程序生效，离开小程序后设置失效。
   */
  export function setKeepScreenOn(any: _setKeepScreenOnObject): void;

  /**
   * wx.setNavigationBarColor({
   */
  export function setNavigationBarColor(
    any: _setNavigationBarColorObject
  ): void;
  ...
  export function setNavigationBarTitle(
    any: _setNavigationBarTitleObject
  ): void;

  /**
   * 设置屏幕亮度。
   */
  export function setScreenBrightness(any: _setScreenBrightnessObject): void;
   ...
   */
  export function setTabBarBadge(any: _setTabBarBadgeObject): void;

  /**
   * 动态设置 tabBar 某一项的内容
   */
  export function setTabBarItem(any: _setTabBarItemObject): void;

  /**
   * 动态设置 tabBar 的整体样式
   */
  export function setTabBarStyle(any: _setTabBarStyleObject): void;
   ...
   */
  export function setTopBarText(any: _setTopBarTextObject): void;

  /**
   * 在 `onGetWifiList` 回调后，利用接口设置 wifiList 中 AP 的相关信息。
   */
  export function setWifiList(any: _setWifiListObject): void;

  /**
   * ​显示操作菜单
   */
  export function showActionSheet(any: _showActionSheetObject): void;

  /**
   * 显示 loading 提示框, 需主动调用 [wx.hideLoading](#wxhideloading) 才能关闭提示框
   */
  export function showLoading(any: any): void;
   ...
   * 显示当前页面的转发按钮
   */
  export function showShareMenu(any: any): void;

  /**
   * 显示 tabBar
   */
  export function showTabBar(any: _showTabBarObject): void;

  /**
   * 显示 tabBar 某一项的右上角的红点
   */
  export function showTabBarRedDot(any: _showTabBarRedDotObject): void;
   ...
   * 开始监听加速度数据。
   */
  export function startAccelerometer(any: _startAccelerometerObject): void;

  /**
   * 开始搜索附近的`iBeacon`设备
   */
  export function startBeaconDiscovery(
    any: _startBeaconDiscoveryObject
  ): void;
  ...
  export function startBluetoothDevicesDiscovery(
    any: _startBluetoothDevicesDiscoveryObject
  ): void;

  /**
   * 开始监听罗盘数据。
   */
  export function startCompass(any: _startCompassObject): void;

  /**
   * 初始化 NFC 模块。
   */
  export function startHCE(any: _startHCEObject): void;

  /**
   * 开始下拉刷新，调用后触发下拉刷新动画，效果与用户手动下拉刷新一致
   */
  export function startPullDownRefresh(
    any: _startPullDownRefreshObject
  ): void;

  /**
   * 开始录音。当主动调用`wx.stopRecord`，或者录音超过1分钟时自动结束录音，返回录音文件的临时文件路径。当用户离开小程序时，此接口无法调用。
   */
  export function startRecord(any: _startRecordObject): void;

  /**
   * 开始 SOTER 生物认证
   */
  export function startSoterAuthentication(
    any: _startSoterAuthenticationObject
  ): void;

  /**
   * 初始化 Wi-Fi 模块。
   */
  export function startWifi(any: _startWifiObject): void;

  /**
   * 停止监听加速度数据。
   */
  export function stopAccelerometer(any: _stopAccelerometerObject): void;
   ...
   * 停止搜索附近的`iBeacon`设备
   */
  export function stopBeaconDiscovery(any: _stopBeaconDiscoveryObject): void;

  /**
   * 停止搜寻附近的蓝牙外围设备。若已经找到需要的蓝牙设备并不需要继续搜索时，建议调用该接口停止蓝牙搜索。
   */
  export function stopBluetoothDevicesDiscovery(
    any: _stopBluetoothDevicesDiscoveryObject
  ): void;

  /**
   * 停止监听罗盘数据。
   */
  export function stopCompass(any: _stopCompassObject): void;

  /**
   * 关闭 NFC 模块。仅在安卓系统下有效。
   */
  export function stopHCE(any: _stopHCEObject): void;
   ...
   * 关闭 Wi-Fi 模块。
   */
  export function stopWifi(any: _stopWifiObject): void;

  /**
   * 跳转到 tabBar 页面，并关闭其他所有非 tabBar 页面
   */
  export function switchTab(any: _switchTabObject): void;

  /**
   * 更新转发属性
   */
  export function updateShareMenu(any: any): void;

  /**
   * 将本地资源上传到开发者服务器，客户端发起一个 HTTPS POST 请求，其中 `content-type` 为 `multipart/form-data` 。**使用前请先阅读[说明](./api-network.md)**。
   */
  export function uploadFile(any: _uploadFileObject): void;
   ...
   * 使手机发生较短时间的振动（15ms）
   */
  export function vibrateShort(obj?: any): void;
  ...
  export function writeBLECharacteristicValue(
    any: _writeBLECharacteristicValueObject
  ): void;

  /**
 * 加载自定义字体文件
 * @param string path 字体文件路径。可以是代码包文件路径，也可以是 wxfile:// 协议的本地文件路径。
 * @return string 如果加载字体成功，则返回字体 family 值，否则返回 null。
 */
  export function loadFont(path: string): string;

  export function accessSync(path: string): any;
